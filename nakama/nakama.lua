...
function M.get_account(
	...
	if callback then
		print("get_account() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("get_account() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_account then
					result = api_account.create(result)
...
function M.authenticate_apple(
	...
	if callback then
		print("authenticate_apple() with callback")
		...
		print("authenticate_apple() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_custom(
	...
	if callback then
		print("authenticate_custom() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_custom() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_device(
	...
	if callback then
		print("authenticate_device() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_device() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_email(
	...
	if callback then
		print("authenticate_email() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_email() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_facebook(
	...
	if callback then
		print("authenticate_facebook() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_facebook() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_facebook_instant_game(
	...
	if callback then
		print("authenticate_facebook_instant_game() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_facebook_instant_game() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_game_center(
	...
	if callback then
		print("authenticate_game_center() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_game_center() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_google(
	...
	if callback then
		print("authenticate_google() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_google() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.authenticate_steam(
	...
	if callback then
		print("authenticate_steam() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("authenticate_steam() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.link_apple(
	...
	if callback then
		print("link_apple() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_apple() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_custom(
	...
	if callback then
		print("link_custom() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_custom() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_device(
	...
	if callback then
		print("link_device() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_device() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_email(
	...
	if callback then
		print("link_email() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_email() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_facebook(
	...
	if callback then
		print("link_facebook() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_facebook() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_facebook_instant_game(
	...
	if callback then
		print("link_facebook_instant_game() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_facebook_instant_game() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_game_center(
	...
	if callback then
		print("link_game_center() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_game_center() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_google(
	...
	if callback then
		print("link_google() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_google() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.link_steam(
	...
	if callback then
		print("link_steam() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("link_steam() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.session_refresh(
	...
	if callback then
		print("session_refresh() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_session then
				result = api_session.create(result)
			end
		...
		print("session_refresh() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_session then
					result = api_session.create(result)
...
function M.unlink_apple(
	...
	if callback then
		print("unlink_apple() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_apple() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_custom(
	...
	if callback then
		print("unlink_custom() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_custom() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_device(
	...
	if callback then
		print("unlink_device() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_device() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_email(
	...
	if callback then
		print("unlink_email() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_email() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_facebook(
	...
	if callback then
		print("unlink_facebook() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_facebook() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_facebook_instant_game(
	...
	if callback then
		print("unlink_facebook_instant_game() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_facebook_instant_game() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_game_center(
	...
	if callback then
		print("unlink_game_center() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_game_center() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_google(
	...
	if callback then
		print("unlink_google() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_google() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.unlink_steam(
	...
	if callback then
		print("unlink_steam() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("unlink_steam() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.list_channel_messages(
	...
	if callback then
		print("list_channel_messages() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_channel_messages() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_channel_message_list then
					result = api_channel_message_list.create(result)
...
function M.event(
	...
	if callback then
		print("event() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("event() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.list_friends(
	...
	if callback then
		print("list_friends() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_friends() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_friend_list then
					result = api_friend_list.create(result)
...
function M.add_friends(
	...
	if callback then
		print("add_friends() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("add_friends() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.block_friends(
	...
	if callback then
		print("block_friends() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("block_friends() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.import_facebook_friends(
	...
	if callback then
		print("import_facebook_friends() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("import_facebook_friends() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.import_steam_friends(
	...
	if callback then
		print("import_steam_friends() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("import_steam_friends() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.list_groups(
	...
	if callback then
		print("list_groups() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_groups() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_group_list then
					result = api_group_list.create(result)
...
function M.create_group(
	...
	if callback then
		print("create_group() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
		...
		print("create_group() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_group then
					result = api_group.create(result)
...
function M.delete_group(
	...
	if callback then
		print("delete_group() with callback")
		client.engine.http(client.config, url_path, query_params, "DELETE", post_data, function(result)
			callback(result)
		end)
	else
		print("delete_group() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "DELETE", post_data, function(result)
				done(result)
			end)
...
function M.update_group(
	...
	if callback then
		print("update_group() with callback")
		client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
			callback(result)
		end)
	else
		print("update_group() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
				done(result)
			end)
...
function M.add_group_users(
	...
	if callback then
		print("add_group_users() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("add_group_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.ban_group_users(
	...
	if callback then
		print("ban_group_users() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("ban_group_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.demote_group_users(
	...
	if callback then
		print("demote_group_users() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("demote_group_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.join_group(
	...
	if callback then
		print("join_group() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("join_group() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.kick_group_users(
	...
	if callback then
		print("kick_group_users() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("kick_group_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.leave_group(
	...
	if callback then
		print("leave_group() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("leave_group() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.promote_group_users(
	...
	if callback then
		print("promote_group_users() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("promote_group_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.list_group_users(
	...
	if callback then
		print("list_group_users() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_group_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_group_user_list then
					result = api_group_user_list.create(result)
...
function M.validate_purchase_apple(
	...
	if callback then
		print("validate_purchase_apple() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
		...
		print("validate_purchase_apple() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_validate_purchase_response then
					result = api_validate_purchase_response.create(result)
...
function M.validate_purchase_google(
	...
	if callback then
		print("validate_purchase_google() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_validate_purchase_response then
				result = api_validate_purchase_response.create(result)
			end
		...
		print("validate_purchase_google() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_validate_purchase_response then
					result = api_validate_purchase_response.create(result)
...
function M.validate_purchase_huawei(
	...
	if callback then
		print("validate_purchase_huawei() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_validate_purchase_response then
				result = api_validate_purchase_response.create(result)
			end
		...
		print("validate_purchase_huawei() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_validate_purchase_response then
					result = api_validate_purchase_response.create(result)
...
function M.delete_leaderboard_record(
	...
	if callback then
		print("delete_leaderboard_record() with callback")
		client.engine.http(client.config, url_path, query_params, "DELETE", post_data, function(result)
			callback(result)
		end)
	else
		print("delete_leaderboard_record() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "DELETE", post_data, function(result)
				done(result)
			end)
...
function M.list_leaderboard_records(
	...
	if callback then
		print("list_leaderboard_records() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_leaderboard_records() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_leaderboard_record_list then
					result = api_leaderboard_record_list.create(result)
...
function M.write_leaderboard_record(
	...
	if callback then
		print("write_leaderboard_record() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
		...
		print("write_leaderboard_record() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_leaderboard_record then
					result = api_leaderboard_record.create(result)
...
function M.list_leaderboard_records_around_owner(
	...
	if callback then
		print("list_leaderboard_records_around_owner() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
			if not result.error and api_leaderboard_record_list then
				result = api_leaderboard_record_list.create(result)
			end
		...
		print("list_leaderboard_records_around_owner() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_leaderboard_record_list then
					result = api_leaderboard_record_list.create(result)
...
function M.list_matches(
	...
	if callback then
		print("list_matches() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_matches() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_match_list then
					result = api_match_list.create(result)
...
function M.delete_notifications(
	...
	if callback then
		print("delete_notifications() with callback")
		client.engine.http(client.config, url_path, query_params, "DELETE", post_data, function(result)
			callback(result)
		end)
	else
		print("delete_notifications() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "DELETE", post_data, function(result)
				done(result)
			end)
...
function M.list_notifications(
	...
	if callback then
		print("list_notifications() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_notifications() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_notification_list then
					result = api_notification_list.create(result)
...
function M.rpc_func2(
	...
	if callback then
		...
		print("rpc_func2() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_rpc then
					result = api_rpc.create(result)
...
function M.session_logout(
	...
	if callback then
		print("session_logout() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("session_logout() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.read_storage_objects(
	...
	if callback then
		print("read_storage_objects() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
		...
		print("read_storage_objects() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_storage_objects then
					result = api_storage_objects.create(result)
...
function M.write_storage_objects(
	...
	if callback then
		print("write_storage_objects() with callback")
		client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
		...
		print("write_storage_objects() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
				if not result.error and api_storage_object_acks then
					result = api_storage_object_acks.create(result)
...
function M.delete_storage_objects(
	...
	if callback then
		print("delete_storage_objects() with callback")
		client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
			callback(result)
		end)
	else
		print("delete_storage_objects() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
				done(result)
			end)
...
function M.list_storage_objects(
	...
	if callback then
		print("list_storage_objects() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_storage_objects() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_storage_object_list then
					result = api_storage_object_list.create(result)
...
function M.list_storage_objects2(
	...
	if callback then
		print("list_storage_objects2() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
			if not result.error and api_storage_object_list then
				result = api_storage_object_list.create(result)
			end
		...
		print("list_storage_objects2() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_storage_object_list then
					result = api_storage_object_list.create(result)
...
function M.list_tournaments(
	...
	if callback then
		print("list_tournaments() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_tournaments() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_tournament_list then
					result = api_tournament_list.create(result)
...
function M.list_tournament_records(
	...
	if callback then
		print("list_tournament_records() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_tournament_records() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_tournament_record_list then
					result = api_tournament_record_list.create(result)
...
function M.write_tournament_record2(
	...
	if callback then
		print("write_tournament_record2() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			if not result.error and api_leaderboard_record then
				result = api_leaderboard_record.create(result)
			end
		...
		print("write_tournament_record2() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				if not result.error and api_leaderboard_record then
					result = api_leaderboard_record.create(result)
...
function M.write_tournament_record(
	...
	if callback then
		print("write_tournament_record() with callback")
		client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
			if not result.error and api_leaderboard_record then
				result = api_leaderboard_record.create(result)
			end
		...
		print("write_tournament_record() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "PUT", post_data, function(result)
				if not result.error and api_leaderboard_record then
					result = api_leaderboard_record.create(result)
...
function M.join_tournament(
	...
	if callback then
		print("join_tournament() with callback")
		client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
			callback(result)
		end)
	else
		print("join_tournament() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "POST", post_data, function(result)
				done(result)
			end)
...
function M.list_tournament_records_around_owner(
	...
	if callback then
		print("list_tournament_records_around_owner() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
			if not result.error and api_tournament_record_list then
				result = api_tournament_record_list.create(result)
			end
		...
		print("list_tournament_records_around_owner() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_tournament_record_list then
					result = api_tournament_record_list.create(result)
...
function M.get_users(
	...
	if callback then
		...
		print("get_users() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_users then
					result = api_users.create(result)
...
function M.list_user_groups(
	...
	if callback then
		print("list_user_groups() with callback")
		client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
		...
		print("list_user_groups() with coroutine")
		return async(function(done)
			client.engine.http(client.config, url_path, query_params, "GET", post_data, function(result)
				if not result.error and api_user_group_list then
					result = api_user_group_list.create(result)
